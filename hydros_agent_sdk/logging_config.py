...
格式字段说明：
- hydros_cluster_id（例如 "hydros-cluster-staging"）
...
class HydrosFormatter(logging.Formatter):
    ...
    示例输出：
    - 智能体：hydros-cluster-staging|default_central|2026-01-28 23:29:48|INFO |TASK202601282328VG3IE7H3CA0F|AGENT_001|coordination_client.py:123|Processing command
    - SDK：   hydros-cluster-staging|default_central|2026-01-28 23:29:48|INFO |SIM_SDK|-|coordination_client.py:123|Loading configuration
    """

    def __init__(
        self,
        default_hydros_cluster_id: str = "hydros-cluster-staging",
...
def setup_logging(
    ...
    hydros_cluster_id: str = "hydros-cluster-staging",
    ...
    Args:
        ...
        hydros_cluster_id: 日志默认集群 ID（默认 "hydros-cluster-staging"）
