...
入口文件 [`__init__.py`](hydros-python-sdk/hydros_agent_sdk/__init__.py) 对外暴露了 SDK 的稳定 API 面，包括：
...
- [`protocol/models.py`](hydros-python-sdk/hydros_agent_sdk/protocol/models.py)
- [`protocol/commands.py`](hydros-python-sdk/hydros_agent_sdk/protocol/commands.py)
- [`protocol/events.py`](hydros-python-sdk/hydros_agent_sdk/protocol/events.py)
- [`protocol/base.py`](hydros-python-sdk/hydros_agent_sdk/protocol/base.py)
...
- [`base_agent.py`](hydros-python-sdk/hydros_agent_sdk/base_agent.py)
- [`agents/tickable_agent.py`](hydros-python-sdk/hydros_agent_sdk/agents/tickable_agent.py)
- [`agents/*.py`](hydros-python-sdk/hydros_agent_sdk/agents)
...
- [`coordination_client.py`](hydros-python-sdk/hydros_agent_sdk/coordination_client.py)
- [`coordination_callback.py`](hydros-python-sdk/hydros_agent_sdk/coordination_callback.py)
- [`mqtt.py`](hydros-python-sdk/hydros_agent_sdk/mqtt.py)
...
- [`state_manager.py`](hydros-python-sdk/hydros_agent_sdk/state_manager.py)
- [`message_filter.py`](hydros-python-sdk/hydros_agent_sdk/message_filter.py)
...
- [`agent_config.py`](hydros-python-sdk/hydros_agent_sdk/agent_config.py)
- [`config_loader.py`](hydros-python-sdk/hydros_agent_sdk/config_loader.py)
- [`factory.py`](hydros-python-sdk/hydros_agent_sdk/factory.py)
- [`multi_agent.py`](hydros-python-sdk/hydros_agent_sdk/multi_agent.py)
- [`logging_config.py`](hydros-python-sdk/hydros_agent_sdk/logging_config.py)
- [`error_codes.py`](hydros-python-sdk/hydros_agent_sdk/error_codes.py)
- [`error_handling.py`](hydros-python-sdk/hydros_agent_sdk/error_handling.py)
