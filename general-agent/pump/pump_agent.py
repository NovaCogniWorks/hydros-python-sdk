...
# Add current directory to Python path for pump_scheduling_solver import
...
# Import example pump scheduling solver implementation
from pump_scheduling_solver import PumpSchedulingSolver
...
class MyTwinsSimulationAgent(TwinsSimulationAgent):
    ...
    2. Initializes pump scheduling solver
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Hydraulic solver
        self._hydraulic_solver: Optional[PumpSchedulingSolver] = None
    ...
    def _initialize_twins_model(self):
        ...
        with AgentErrorContext(
            ...
            self._hydraulic_solver = PumpSchedulingSolver()
